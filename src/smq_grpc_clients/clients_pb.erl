...
-type authn_res() ::
      #{authenticated           => boolean() | 0 | 1, % = 1, optional
        id                      => unicode:chardata() % = 2, optional
       }.

-type remove_channel_connections_req() ::
      #{channel_id              => unicode:chardata() % = 1, optional
       }.

-type remove_channel_connections_res() ::
      #{
       }.

-type unset_parent_group_from_client_req() ::
      #{parent_group_id         => unicode:chardata() % = 1, optional
       }.

-type unset_parent_group_from_client_res() ::
      #{
       }.
...
-export_type(['authn_req'/0, 'authn_res'/0, 'remove_channel_connections_req'/0, 'remove_channel_connections_res'/0, 'unset_parent_group_from_client_req'/0, 'unset_parent_group_from_client_res'/0, 'retrieve_entities_req'/0, 'retrieve_entities_res'/0, 'retrieve_entity_req'/0, 'retrieve_entity_res'/0, 'entity_basic'/0, 'add_connections_req'/0, 'add_connections_res'/0, 'remove_connections_req'/0, 'remove_connections_res'/0, 'connection'/0, 'retrieve_id_by_route_req'/0]).
-type '$msg_name'() :: authn_req | authn_res | remove_channel_connections_req | remove_channel_connections_res | unset_parent_group_from_client_req | unset_parent_group_from_client_res | retrieve_entities_req | retrieve_entities_res | retrieve_entity_req | retrieve_entity_res | entity_basic | add_connections_req | add_connections_res | remove_connections_req | remove_connections_res | connection | retrieve_id_by_route_req.
-type '$msg'() :: authn_req() | authn_res() | remove_channel_connections_req() | remove_channel_connections_res() | unset_parent_group_from_client_req() | unset_parent_group_from_client_res() | retrieve_entities_req() | retrieve_entities_res() | retrieve_entity_req() | retrieve_entity_res() | entity_basic() | add_connections_req() | add_connections_res() | remove_connections_req() | remove_connections_res() | connection() | retrieve_id_by_route_req().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        authn_req -> encode_msg_authn_req(id(Msg, TrUserData), TrUserData);
        authn_res -> encode_msg_authn_res(id(Msg, TrUserData), TrUserData);
        remove_channel_connections_req -> encode_msg_remove_channel_connections_req(id(Msg, TrUserData), TrUserData);
        remove_channel_connections_res -> encode_msg_remove_channel_connections_res(id(Msg, TrUserData), TrUserData);
        unset_parent_group_from_client_req -> encode_msg_unset_parent_group_from_client_req(id(Msg, TrUserData), TrUserData);
        unset_parent_group_from_client_res -> encode_msg_unset_parent_group_from_client_res(id(Msg, TrUserData), TrUserData);
...
encode_msg_authn_req(Msg, TrUserData) -> encode_msg_authn_req(Msg, <<>>, TrUserData).


encode_msg_authn_req(#{} = M, Bin, TrUserData) ->
    case M of
        #{token := F1} ->
            begin
...
encode_msg_authn_res(Msg, TrUserData) -> encode_msg_authn_res(Msg, <<>>, TrUserData).


encode_msg_authn_res(#{} = M, Bin, TrUserData) ->
    B1 = case M of
             #{authenticated := F1} ->
                 begin
                     TrF1 = id(F1, TrUserData),
...
encode_msg_remove_channel_connections_req(Msg, TrUserData) -> encode_msg_remove_channel_connections_req(Msg, <<>>, TrUserData).


encode_msg_remove_channel_connections_req(#{} = M, Bin, TrUserData) ->
    case M of
        #{channel_id := F1} ->
            begin
                TrF1 = id(F1, TrUserData),
...
encode_msg_remove_channel_connections_res(_Msg, _TrUserData) -> <<>>.

encode_msg_unset_parent_group_from_client_req(Msg, TrUserData) -> encode_msg_unset_parent_group_from_client_req(Msg, <<>>, TrUserData).


encode_msg_unset_parent_group_from_client_req(#{} = M, Bin, TrUserData) ->
    case M of
        #{parent_group_id := F1} ->
            begin
                TrF1 = id(F1, TrUserData),
...
encode_msg_unset_parent_group_from_client_res(_Msg, _TrUserData) -> <<>>.
...
decode_msg_2_doit(authn_req, Bin, TrUserData) -> id(decode_msg_authn_req(Bin, TrUserData), TrUserData);
decode_msg_2_doit(authn_res, Bin, TrUserData) -> id(decode_msg_authn_res(Bin, TrUserData), TrUserData);
decode_msg_2_doit(remove_channel_connections_req, Bin, TrUserData) -> id(decode_msg_remove_channel_connections_req(Bin, TrUserData), TrUserData);
decode_msg_2_doit(remove_channel_connections_res, Bin, TrUserData) -> id(decode_msg_remove_channel_connections_res(Bin, TrUserData), TrUserData);
decode_msg_2_doit(unset_parent_group_from_client_req, Bin, TrUserData) -> id(decode_msg_unset_parent_group_from_client_req(Bin, TrUserData), TrUserData);
decode_msg_2_doit(unset_parent_group_from_client_res, Bin, TrUserData) -> id(decode_msg_unset_parent_group_from_client_res(Bin, TrUserData), TrUserData);
...
decode_msg_authn_req(Bin, TrUserData) -> dfp_read_field_def_authn_req(Bin, 0, 0, 0, id(<<>>, TrUserData), TrUserData).

dfp_read_field_def_authn_req(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_authn_req_token(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_authn_req(<<>>, 0, 0, _, F@_1, _) -> #{token => F@_1};
dfp_read_field_def_authn_req(Other, Z1, Z2, F, F@_1, TrUserData) -> dg_read_field_def_authn_req(Other, Z1, Z2, F, F@_1, TrUserData).

dg_read_field_def_authn_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_authn_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
dg_read_field_def_authn_req(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_authn_req_token(Rest, 0, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_authn_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                1 -> skip_64_authn_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                2 -> skip_length_delimited_authn_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                3 -> skip_group_authn_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                5 -> skip_32_authn_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData)
            end
    end;
dg_read_field_def_authn_req(<<>>, 0, 0, _, F@_1, _) -> #{token => F@_1}.

d_field_authn_req_token(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> d_field_authn_req_token(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
d_field_authn_req_token(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_authn_req(RestF, 0, 0, F, NewFValue, TrUserData).

skip_varint_authn_req(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> skip_varint_authn_req(Rest, Z1, Z2, F, F@_1, TrUserData);
skip_varint_authn_req(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_authn_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_length_delimited_authn_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> skip_length_delimited_authn_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
skip_length_delimited_authn_req(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_authn_req(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_authn_req(Bin, _, Z2, FNum, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_authn_req(Rest, 0, Z2, FNum, F@_1, TrUserData).

skip_32_authn_req(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_authn_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_64_authn_req(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_authn_req(Rest, Z1, Z2, F, F@_1, TrUserData).

decode_msg_authn_res(Bin, TrUserData) -> dfp_read_field_def_authn_res(Bin, 0, 0, 0, id(false, TrUserData), id(<<>>, TrUserData), TrUserData).

dfp_read_field_def_authn_res(<<8, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> d_field_authn_res_authenticated(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData);
dfp_read_field_def_authn_res(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> d_field_authn_res_id(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData);
dfp_read_field_def_authn_res(<<>>, 0, 0, _, F@_1, F@_2, _) -> #{authenticated => F@_1, id => F@_2};
dfp_read_field_def_authn_res(Other, Z1, Z2, F, F@_1, F@_2, TrUserData) -> dg_read_field_def_authn_res(Other, Z1, Z2, F, F@_1, F@_2, TrUserData).

dg_read_field_def_authn_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 32 - 7 -> dg_read_field_def_authn_res(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
dg_read_field_def_authn_res(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 -> d_field_authn_res_authenticated(Rest, 0, 0, 0, F@_1, F@_2, TrUserData);
        18 -> d_field_authn_res_id(Rest, 0, 0, 0, F@_1, F@_2, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_authn_res(Rest, 0, 0, Key bsr 3, F@_1, F@_2, TrUserData);
                1 -> skip_64_authn_res(Rest, 0, 0, Key bsr 3, F@_1, F@_2, TrUserData);
                2 -> skip_length_delimited_authn_res(Rest, 0, 0, Key bsr 3, F@_1, F@_2, TrUserData);
                3 -> skip_group_authn_res(Rest, 0, 0, Key bsr 3, F@_1, F@_2, TrUserData);
                5 -> skip_32_authn_res(Rest, 0, 0, Key bsr 3, F@_1, F@_2, TrUserData)
            end
    end;
dg_read_field_def_authn_res(<<>>, 0, 0, _, F@_1, F@_2, _) -> #{authenticated => F@_1, id => F@_2}.

d_field_authn_res_authenticated(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 57 -> d_field_authn_res_authenticated(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
d_field_authn_res_authenticated(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest},
    dfp_read_field_def_authn_res(RestF, 0, 0, F, NewFValue, F@_2, TrUserData).

d_field_authn_res_id(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 57 -> d_field_authn_res_id(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
d_field_authn_res_id(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_authn_res(RestF, 0, 0, F, F@_1, NewFValue, TrUserData).

skip_varint_authn_res(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> skip_varint_authn_res(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData);
skip_varint_authn_res(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> dfp_read_field_def_authn_res(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData).

skip_length_delimited_authn_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) when N < 57 -> skip_length_delimited_authn_res(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, TrUserData);
skip_length_delimited_authn_res(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_authn_res(Rest2, 0, 0, F, F@_1, F@_2, TrUserData).

skip_group_authn_res(Bin, _, Z2, FNum, F@_1, F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_authn_res(Rest, 0, Z2, FNum, F@_1, F@_2, TrUserData).

skip_32_authn_res(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> dfp_read_field_def_authn_res(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData).

skip_64_authn_res(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, TrUserData) -> dfp_read_field_def_authn_res(Rest, Z1, Z2, F, F@_1, F@_2, TrUserData).

decode_msg_remove_channel_connections_req(Bin, TrUserData) -> dfp_read_field_def_remove_channel_connections_req(Bin, 0, 0, 0, id(<<>>, TrUserData), TrUserData).

dfp_read_field_def_remove_channel_connections_req(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_remove_channel_connections_req_channel_id(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_remove_channel_connections_req(<<>>, 0, 0, _, F@_1, _) -> #{channel_id => F@_1};
dfp_read_field_def_remove_channel_connections_req(Other, Z1, Z2, F, F@_1, TrUserData) -> dg_read_field_def_remove_channel_connections_req(Other, Z1, Z2, F, F@_1, TrUserData).

dg_read_field_def_remove_channel_connections_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_remove_channel_connections_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
dg_read_field_def_remove_channel_connections_req(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_remove_channel_connections_req_channel_id(Rest, 0, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_remove_channel_connections_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                1 -> skip_64_remove_channel_connections_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                2 -> skip_length_delimited_remove_channel_connections_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                3 -> skip_group_remove_channel_connections_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                5 -> skip_32_remove_channel_connections_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData)
            end
    end;
dg_read_field_def_remove_channel_connections_req(<<>>, 0, 0, _, F@_1, _) -> #{channel_id => F@_1}.

d_field_remove_channel_connections_req_channel_id(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> d_field_remove_channel_connections_req_channel_id(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
d_field_remove_channel_connections_req_channel_id(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_remove_channel_connections_req(RestF, 0, 0, F, NewFValue, TrUserData).

skip_varint_remove_channel_connections_req(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> skip_varint_remove_channel_connections_req(Rest, Z1, Z2, F, F@_1, TrUserData);
skip_varint_remove_channel_connections_req(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_remove_channel_connections_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_length_delimited_remove_channel_connections_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> skip_length_delimited_remove_channel_connections_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
skip_length_delimited_remove_channel_connections_req(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_remove_channel_connections_req(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_remove_channel_connections_req(Bin, _, Z2, FNum, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_remove_channel_connections_req(Rest, 0, Z2, FNum, F@_1, TrUserData).

skip_32_remove_channel_connections_req(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_remove_channel_connections_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_64_remove_channel_connections_req(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_remove_channel_connections_req(Rest, Z1, Z2, F, F@_1, TrUserData).

decode_msg_remove_channel_connections_res(Bin, TrUserData) -> dfp_read_field_def_remove_channel_connections_res(Bin, 0, 0, 0, TrUserData).

dfp_read_field_def_remove_channel_connections_res(<<>>, 0, 0, _, _) -> #{};
dfp_read_field_def_remove_channel_connections_res(Other, Z1, Z2, F, TrUserData) -> dg_read_field_def_remove_channel_connections_res(Other, Z1, Z2, F, TrUserData).

dg_read_field_def_remove_channel_connections_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 32 - 7 -> dg_read_field_def_remove_channel_connections_res(Rest, N + 7, X bsl N + Acc, F, TrUserData);
dg_read_field_def_remove_channel_connections_res(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
        0 -> skip_varint_remove_channel_connections_res(Rest, 0, 0, Key bsr 3, TrUserData);
        1 -> skip_64_remove_channel_connections_res(Rest, 0, 0, Key bsr 3, TrUserData);
        2 -> skip_length_delimited_remove_channel_connections_res(Rest, 0, 0, Key bsr 3, TrUserData);
        3 -> skip_group_remove_channel_connections_res(Rest, 0, 0, Key bsr 3, TrUserData);
        5 -> skip_32_remove_channel_connections_res(Rest, 0, 0, Key bsr 3, TrUserData)
    end;
dg_read_field_def_remove_channel_connections_res(<<>>, 0, 0, _, _) -> #{}.

skip_varint_remove_channel_connections_res(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> skip_varint_remove_channel_connections_res(Rest, Z1, Z2, F, TrUserData);
skip_varint_remove_channel_connections_res(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_remove_channel_connections_res(Rest, Z1, Z2, F, TrUserData).

skip_length_delimited_remove_channel_connections_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 57 -> skip_length_delimited_remove_channel_connections_res(Rest, N + 7, X bsl N + Acc, F, TrUserData);
skip_length_delimited_remove_channel_connections_res(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_remove_channel_connections_res(Rest2, 0, 0, F, TrUserData).

skip_group_remove_channel_connections_res(Bin, _, Z2, FNum, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_remove_channel_connections_res(Rest, 0, Z2, FNum, TrUserData).

skip_32_remove_channel_connections_res(<<_:32, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_remove_channel_connections_res(Rest, Z1, Z2, F, TrUserData).

skip_64_remove_channel_connections_res(<<_:64, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_remove_channel_connections_res(Rest, Z1, Z2, F, TrUserData).

decode_msg_unset_parent_group_from_client_req(Bin, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_req(Bin, 0, 0, 0, id(<<>>, TrUserData), TrUserData).

dfp_read_field_def_unset_parent_group_from_client_req(<<10, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> d_field_unset_parent_group_from_client_req_parent_group_id(Rest, Z1, Z2, F, F@_1, TrUserData);
dfp_read_field_def_unset_parent_group_from_client_req(<<>>, 0, 0, _, F@_1, _) -> #{parent_group_id => F@_1};
dfp_read_field_def_unset_parent_group_from_client_req(Other, Z1, Z2, F, F@_1, TrUserData) -> dg_read_field_def_unset_parent_group_from_client_req(Other, Z1, Z2, F, F@_1, TrUserData).

dg_read_field_def_unset_parent_group_from_client_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 32 - 7 -> dg_read_field_def_unset_parent_group_from_client_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
dg_read_field_def_unset_parent_group_from_client_req(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> d_field_unset_parent_group_from_client_req_parent_group_id(Rest, 0, 0, 0, F@_1, TrUserData);
        _ ->
            case Key band 7 of
                0 -> skip_varint_unset_parent_group_from_client_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                1 -> skip_64_unset_parent_group_from_client_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                2 -> skip_length_delimited_unset_parent_group_from_client_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                3 -> skip_group_unset_parent_group_from_client_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData);
                5 -> skip_32_unset_parent_group_from_client_req(Rest, 0, 0, Key bsr 3, F@_1, TrUserData)
            end
    end;
dg_read_field_def_unset_parent_group_from_client_req(<<>>, 0, 0, _, F@_1, _) -> #{parent_group_id => F@_1}.

d_field_unset_parent_group_from_client_req_parent_group_id(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> d_field_unset_parent_group_from_client_req_parent_group_id(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
d_field_unset_parent_group_from_client_req_parent_group_id(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    dfp_read_field_def_unset_parent_group_from_client_req(RestF, 0, 0, F, NewFValue, TrUserData).

skip_varint_unset_parent_group_from_client_req(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> skip_varint_unset_parent_group_from_client_req(Rest, Z1, Z2, F, F@_1, TrUserData);
skip_varint_unset_parent_group_from_client_req(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_length_delimited_unset_parent_group_from_client_req(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) when N < 57 -> skip_length_delimited_unset_parent_group_from_client_req(Rest, N + 7, X bsl N + Acc, F, F@_1, TrUserData);
skip_length_delimited_unset_parent_group_from_client_req(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_unset_parent_group_from_client_req(Rest2, 0, 0, F, F@_1, TrUserData).

skip_group_unset_parent_group_from_client_req(Bin, _, Z2, FNum, F@_1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_unset_parent_group_from_client_req(Rest, 0, Z2, FNum, F@_1, TrUserData).

skip_32_unset_parent_group_from_client_req(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_req(Rest, Z1, Z2, F, F@_1, TrUserData).

skip_64_unset_parent_group_from_client_req(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_req(Rest, Z1, Z2, F, F@_1, TrUserData).

decode_msg_unset_parent_group_from_client_res(Bin, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_res(Bin, 0, 0, 0, TrUserData).

dfp_read_field_def_unset_parent_group_from_client_res(<<>>, 0, 0, _, _) -> #{};
dfp_read_field_def_unset_parent_group_from_client_res(Other, Z1, Z2, F, TrUserData) -> dg_read_field_def_unset_parent_group_from_client_res(Other, Z1, Z2, F, TrUserData).

dg_read_field_def_unset_parent_group_from_client_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 32 - 7 -> dg_read_field_def_unset_parent_group_from_client_res(Rest, N + 7, X bsl N + Acc, F, TrUserData);
dg_read_field_def_unset_parent_group_from_client_res(<<0:1, X:7, Rest/binary>>, N, Acc, _, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
        0 -> skip_varint_unset_parent_group_from_client_res(Rest, 0, 0, Key bsr 3, TrUserData);
        1 -> skip_64_unset_parent_group_from_client_res(Rest, 0, 0, Key bsr 3, TrUserData);
        2 -> skip_length_delimited_unset_parent_group_from_client_res(Rest, 0, 0, Key bsr 3, TrUserData);
        3 -> skip_group_unset_parent_group_from_client_res(Rest, 0, 0, Key bsr 3, TrUserData);
        5 -> skip_32_unset_parent_group_from_client_res(Rest, 0, 0, Key bsr 3, TrUserData)
    end;
dg_read_field_def_unset_parent_group_from_client_res(<<>>, 0, 0, _, _) -> #{}.

skip_varint_unset_parent_group_from_client_res(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> skip_varint_unset_parent_group_from_client_res(Rest, Z1, Z2, F, TrUserData);
skip_varint_unset_parent_group_from_client_res(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_res(Rest, Z1, Z2, F, TrUserData).

skip_length_delimited_unset_parent_group_from_client_res(<<1:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) when N < 57 -> skip_length_delimited_unset_parent_group_from_client_res(Rest, N + 7, X bsl N + Acc, F, TrUserData);
skip_length_delimited_unset_parent_group_from_client_res(<<0:1, X:7, Rest/binary>>, N, Acc, F, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_unset_parent_group_from_client_res(Rest2, 0, 0, F, TrUserData).

skip_group_unset_parent_group_from_client_res(Bin, _, Z2, FNum, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_unset_parent_group_from_client_res(Rest, 0, Z2, FNum, TrUserData).

skip_32_unset_parent_group_from_client_res(<<_:32, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_res(Rest, Z1, Z2, F, TrUserData).

skip_64_unset_parent_group_from_client_res(<<_:64, Rest/binary>>, Z1, Z2, F, TrUserData) -> dfp_read_field_def_unset_parent_group_from_client_res(Rest, Z1, Z2, F, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        authn_req -> merge_msg_authn_req(Prev, New, TrUserData);
        authn_res -> merge_msg_authn_res(Prev, New, TrUserData);
        remove_channel_connections_req -> merge_msg_remove_channel_connections_req(Prev, New, TrUserData);
        remove_channel_connections_res -> merge_msg_remove_channel_connections_res(Prev, New, TrUserData);
        unset_parent_group_from_client_req -> merge_msg_unset_parent_group_from_client_req(Prev, New, TrUserData);
        unset_parent_group_from_client_res -> merge_msg_unset_parent_group_from_client_res(Prev, New, TrUserData);
...
-compile({nowarn_unused_function,merge_msg_authn_req/3}).
merge_msg_authn_req(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
...
-compile({nowarn_unused_function,merge_msg_authn_res/3}).
merge_msg_authn_res(PMsg, NMsg, _) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
             {_, #{authenticated := NFauthenticated}} -> S1#{authenticated => NFauthenticated};
             {#{authenticated := PFauthenticated}, _} -> S1#{authenticated => PFauthenticated};
             _ -> S1
         end,
    case {PMsg, NMsg} of
...
-compile({nowarn_unused_function,merge_msg_remove_channel_connections_req/3}).
merge_msg_remove_channel_connections_req(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
        {_, #{channel_id := NFchannel_id}} -> S1#{channel_id => NFchannel_id};
        {#{channel_id := PFchannel_id}, _} -> S1#{channel_id => PFchannel_id};
        _ -> S1
    end.

-compile({nowarn_unused_function,merge_msg_remove_channel_connections_res/3}).
merge_msg_remove_channel_connections_res(_Prev, New, _TrUserData) -> New.

-compile({nowarn_unused_function,merge_msg_unset_parent_group_from_client_req/3}).
merge_msg_unset_parent_group_from_client_req(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
...
-compile({nowarn_unused_function,merge_msg_unset_parent_group_from_client_res/3}).
merge_msg_unset_parent_group_from_client_res(_Prev, New, _TrUserData) -> New.
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        authn_req -> v_msg_authn_req(Msg, [MsgName], TrUserData);
        authn_res -> v_msg_authn_res(Msg, [MsgName], TrUserData);
        remove_channel_connections_req -> v_msg_remove_channel_connections_req(Msg, [MsgName], TrUserData);
        remove_channel_connections_res -> v_msg_remove_channel_connections_res(Msg, [MsgName], TrUserData);
        unset_parent_group_from_client_req -> v_msg_unset_parent_group_from_client_req(Msg, [MsgName], TrUserData);
        unset_parent_group_from_client_res -> v_msg_unset_parent_group_from_client_res(Msg, [MsgName], TrUserData);
...
-compile({nowarn_unused_function,v_msg_authn_req/3}).
-dialyzer({nowarn_function,v_msg_authn_req/3}).
v_msg_authn_req(#{} = M, Path, TrUserData) ->
    case M of
    ...
    lists:foreach(fun (token) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_authn_req(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), authn_req}, M, Path);
v_msg_authn_req(X, Path, _TrUserData) -> mk_type_error({expected_msg, authn_req}, X, Path).

-compile({nowarn_unused_function,v_msg_authn_res/3}).
-dialyzer({nowarn_function,v_msg_authn_res/3}).
v_msg_authn_res(#{} = M, Path, TrUserData) ->
    case M of
        #{authenticated := F1} -> v_type_bool(F1, [authenticated | Path], TrUserData);
        _ -> ok
    end,
    case M of
    ...
    lists:foreach(fun (authenticated) -> ok;
                      (id) -> ok;
                      (OtherKey) -> mk_type_error({extraneous_key, OtherKey}, M, Path)
                  end,
                  maps:keys(M)),
    ok;
v_msg_authn_res(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), authn_res}, M, Path);
v_msg_authn_res(X, Path, _TrUserData) -> mk_type_error({expected_msg, authn_res}, X, Path).

-compile({nowarn_unused_function,v_msg_remove_channel_connections_req/3}).
-dialyzer({nowarn_function,v_msg_remove_channel_connections_req/3}).
v_msg_remove_channel_connections_req(#{} = M, Path, TrUserData) ->
    case M of
        #{channel_id := F1} -> v_type_string(F1, [channel_id | Path], TrUserData);
        _ -> ok
    end,
    lists:foreach(fun (channel_id) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_remove_channel_connections_req(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), remove_channel_connections_req}, M, Path);
v_msg_remove_channel_connections_req(X, Path, _TrUserData) -> mk_type_error({expected_msg, remove_channel_connections_req}, X, Path).

-compile({nowarn_unused_function,v_msg_remove_channel_connections_res/3}).
-dialyzer({nowarn_function,v_msg_remove_channel_connections_res/3}).
v_msg_remove_channel_connections_res(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) -> mk_type_error({extraneous_key, OtherKey}, M, Path) end, maps:keys(M)),
    ok;
v_msg_remove_channel_connections_res(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), remove_channel_connections_res}, M, Path);
v_msg_remove_channel_connections_res(X, Path, _TrUserData) -> mk_type_error({expected_msg, remove_channel_connections_res}, X, Path).

-compile({nowarn_unused_function,v_msg_unset_parent_group_from_client_req/3}).
-dialyzer({nowarn_function,v_msg_unset_parent_group_from_client_req/3}).
v_msg_unset_parent_group_from_client_req(#{} = M, Path, TrUserData) ->
    case M of
    ...
    lists:foreach(fun (parent_group_id) -> ok;
                  ...
                  maps:keys(M)),
    ok;
v_msg_unset_parent_group_from_client_req(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), unset_parent_group_from_client_req}, M, Path);
v_msg_unset_parent_group_from_client_req(X, Path, _TrUserData) -> mk_type_error({expected_msg, unset_parent_group_from_client_req}, X, Path).

-compile({nowarn_unused_function,v_msg_unset_parent_group_from_client_res/3}).
-dialyzer({nowarn_function,v_msg_unset_parent_group_from_client_res/3}).
v_msg_unset_parent_group_from_client_res(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) -> mk_type_error({extraneous_key, OtherKey}, M, Path) end, maps:keys(M)),
    ok;
v_msg_unset_parent_group_from_client_res(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), unset_parent_group_from_client_res}, M, Path);
v_msg_unset_parent_group_from_client_res(X, Path, _TrUserData) -> mk_type_error({expected_msg, unset_parent_group_from_client_res}, X, Path).
...
get_msg_defs() ->
    [{{msg, authn_req}, [#{name => token, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}]},
     {{msg, authn_res}, [#{name => authenticated, fnum => 1, rnum => 2, type => bool, occurrence => optional, opts => []}, #{name => id, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []}]},
     {{msg, remove_channel_connections_req}, [#{name => channel_id, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}]},
     {{msg, remove_channel_connections_res}, []},
     {{msg, unset_parent_group_from_client_req}, [#{name => parent_group_id, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}]},
     {{msg, unset_parent_group_from_client_res}, []},
...
get_msg_names() ->
    [authn_req,
     authn_res,
     remove_channel_connections_req,
     remove_channel_connections_res,
     unset_parent_group_from_client_req,
     unset_parent_group_from_client_res,
...
find_msg_def(authn_req) -> [#{name => token, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}];
find_msg_def(authn_res) -> [#{name => authenticated, fnum => 1, rnum => 2, type => bool, occurrence => optional, opts => []}, #{name => id, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []}];
find_msg_def(remove_channel_connections_req) -> [#{name => channel_id, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}];
find_msg_def(remove_channel_connections_res) -> [];
find_msg_def(unset_parent_group_from_client_req) -> [#{name => parent_group_id, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}];
find_msg_def(unset_parent_group_from_client_res) -> [];
...
get_service_names() -> ['clients.v1.ClientsService'].


get_service_def('clients.v1.ClientsService') ->
    {{service, 'clients.v1.ClientsService'},
     [#{name => 'Authenticate', input => authn_req, output => authn_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'RetrieveEntity', input => retrieve_entity_req, output => retrieve_entity_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'RetrieveEntities', input => retrieve_entities_req, output => retrieve_entities_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'AddConnections', input => add_connections_req, output => add_connections_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'RemoveConnections', input => remove_connections_req, output => remove_connections_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'RemoveChannelConnections', input => remove_channel_connections_req, output => remove_channel_connections_res, input_stream => false, output_stream => false, opts => []},
      #{name => 'UnsetParentGroupFromClient', input => unset_parent_group_from_client_req, output => unset_parent_group_from_client_res, input_stream => false, output_stream => false, opts => []}]};
get_service_def(_) -> error.


get_rpc_names('clients.v1.ClientsService') -> ['Authenticate', 'RetrieveEntity', 'RetrieveEntities', 'AddConnections', 'RemoveConnections', 'RemoveChannelConnections', 'UnsetParentGroupFromClient'];
get_rpc_names(_) -> error.


find_rpc_def('clients.v1.ClientsService', RpcName) -> 'find_rpc_def_clients.v1.ClientsService'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_clients.v1.ClientsService'('Authenticate') -> #{name => 'Authenticate', input => authn_req, output => authn_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('RetrieveEntity') -> #{name => 'RetrieveEntity', input => retrieve_entity_req, output => retrieve_entity_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('RetrieveEntities') -> #{name => 'RetrieveEntities', input => retrieve_entities_req, output => retrieve_entities_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('AddConnections') -> #{name => 'AddConnections', input => add_connections_req, output => add_connections_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('RemoveConnections') -> #{name => 'RemoveConnections', input => remove_connections_req, output => remove_connections_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('RemoveChannelConnections') ->
    #{name => 'RemoveChannelConnections', input => remove_channel_connections_req, output => remove_channel_connections_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'('UnsetParentGroupFromClient') ->
    #{name => 'UnsetParentGroupFromClient', input => unset_parent_group_from_client_req, output => unset_parent_group_from_client_res, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_clients.v1.ClientsService'(_) -> error.
...
fqbin_to_service_name(<<"clients.v1.ClientsService">>) -> 'clients.v1.ClientsService';
fqbin_to_service_name(X) -> error({gpb_error, {badservice, X}}).


%% Convert a service name as an atom to a fully qualified
%% (ie with package name) name as a binary.
service_name_to_fqbin('clients.v1.ClientsService') -> <<"clients.v1.ClientsService">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"Authenticate">>) -> {'clients.v1.ClientsService', 'Authenticate'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"RetrieveEntity">>) -> {'clients.v1.ClientsService', 'RetrieveEntity'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"RetrieveEntities">>) -> {'clients.v1.ClientsService', 'RetrieveEntities'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"AddConnections">>) -> {'clients.v1.ClientsService', 'AddConnections'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"RemoveConnections">>) -> {'clients.v1.ClientsService', 'RemoveConnections'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"RemoveChannelConnections">>) -> {'clients.v1.ClientsService', 'RemoveChannelConnections'};
fqbins_to_service_and_rpc_name(<<"clients.v1.ClientsService">>, <<"UnsetParentGroupFromClient">>) -> {'clients.v1.ClientsService', 'UnsetParentGroupFromClient'};
...
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'Authenticate') -> {<<"clients.v1.ClientsService">>, <<"Authenticate">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'RetrieveEntity') -> {<<"clients.v1.ClientsService">>, <<"RetrieveEntity">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'RetrieveEntities') -> {<<"clients.v1.ClientsService">>, <<"RetrieveEntities">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'AddConnections') -> {<<"clients.v1.ClientsService">>, <<"AddConnections">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'RemoveConnections') -> {<<"clients.v1.ClientsService">>, <<"RemoveConnections">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'RemoveChannelConnections') -> {<<"clients.v1.ClientsService">>, <<"RemoveChannelConnections">>};
service_and_rpc_name_to_fqbins('clients.v1.ClientsService', 'UnsetParentGroupFromClient') -> {<<"clients.v1.ClientsService">>, <<"UnsetParentGroupFromClient">>};
service_and_rpc_name_to_fqbins(S, R) -> error({gpb_error, {badservice_or_rpc, {S, R}}}).


fqbin_to_msg_name(<<"clients.v1.AuthnReq">>) -> authn_req;
fqbin_to_msg_name(<<"clients.v1.AuthnRes">>) -> authn_res;
fqbin_to_msg_name(<<"clients.v1.RemoveChannelConnectionsReq">>) -> remove_channel_connections_req;
fqbin_to_msg_name(<<"clients.v1.RemoveChannelConnectionsRes">>) -> remove_channel_connections_res;
fqbin_to_msg_name(<<"clients.v1.UnsetParentGroupFromClientReq">>) -> unset_parent_group_from_client_req;
fqbin_to_msg_name(<<"clients.v1.UnsetParentGroupFromClientRes">>) -> unset_parent_group_from_client_res;
...
msg_name_to_fqbin(authn_req) -> <<"clients.v1.AuthnReq">>;
msg_name_to_fqbin(authn_res) -> <<"clients.v1.AuthnRes">>;
msg_name_to_fqbin(remove_channel_connections_req) -> <<"clients.v1.RemoveChannelConnectionsReq">>;
msg_name_to_fqbin(remove_channel_connections_res) -> <<"clients.v1.RemoveChannelConnectionsRes">>;
msg_name_to_fqbin(unset_parent_group_from_client_req) -> <<"clients.v1.UnsetParentGroupFromClientReq">>;
msg_name_to_fqbin(unset_parent_group_from_client_res) -> <<"clients.v1.UnsetParentGroupFromClientRes">>;
...
get_all_source_basenames() -> ["clients.proto", "common.proto"].
...
%% functions.
get_all_proto_names() -> ["clients", "common"].


get_msg_containment("clients") -> [authn_req, authn_res, remove_channel_connections_req, remove_channel_connections_res, unset_parent_group_from_client_req, unset_parent_group_from_client_res];
...
get_pkg_containment("clients") -> 'clients.v1';
get_pkg_containment("common") -> 'common.v1';
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("clients") -> ['clients.v1.ClientsService'];
get_service_containment("common") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("clients") ->
    [{'clients.v1.ClientsService', 'Authenticate'},
     {'clients.v1.ClientsService', 'RetrieveEntity'},
     {'clients.v1.ClientsService', 'RetrieveEntities'},
     {'clients.v1.ClientsService', 'AddConnections'},
     {'clients.v1.ClientsService', 'RemoveConnections'},
     {'clients.v1.ClientsService', 'RemoveChannelConnections'},
     {'clients.v1.ClientsService', 'UnsetParentGroupFromClient'}];
get_rpc_containment("common") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("clients") -> [];
...
get_proto_by_msg_name_as_fqbin(<<"clients.v1.UnsetParentGroupFromClientReq">>) -> "clients";
get_proto_by_msg_name_as_fqbin(<<"clients.v1.RemoveChannelConnectionsReq">>) -> "clients";
get_proto_by_msg_name_as_fqbin(<<"clients.v1.AuthnReq">>) -> "clients";
...
get_proto_by_msg_name_as_fqbin(<<"clients.v1.UnsetParentGroupFromClientRes">>) -> "clients";
get_proto_by_msg_name_as_fqbin(<<"clients.v1.RemoveChannelConnectionsRes">>) -> "clients";
get_proto_by_msg_name_as_fqbin(<<"clients.v1.AuthnRes">>) -> "clients";
get_proto_by_msg_name_as_fqbin(<<"common.v1.Connection">>) -> "common";
get_proto_by_msg_name_as_fqbin(E) -> error({gpb_error, {badmsg, E}}).


get_proto_by_service_name_as_fqbin(<<"clients.v1.ClientsService">>) -> "clients";
...
get_protos_by_pkg_name_as_fqbin(<<"clients.v1">>) -> ["clients"];
