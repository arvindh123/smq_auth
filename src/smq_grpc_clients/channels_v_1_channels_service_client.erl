...
-spec authorize(channels_pb:authz_req()) ->
    {ok, channels_pb:authz_res(), grpcbox:metadata()}
...
-spec authorize(
    ctx:t() | channels_pb:authz_req(), channels_pb:authz_req() | grpcbox_client:options()
) ->
    {ok, channels_pb:authz_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
authorize(Ctx, Input, Options) ->
    grpcbox_client:unary(
        ...
        Input,
        ?DEF(authz_req, authz_res, <<"channels.v1.AuthzReq">>),
        Options
    ).

%% @doc Unary RPC
-spec remove_client_connections(channels_pb:remove_client_connections_req()) ->
    {ok, channels_pb:remove_client_connections_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
remove_client_connections(Input) ->
    remove_client_connections(ctx:new(), Input, #{}).

-spec remove_client_connections(
    ctx:t() | channels_pb:remove_client_connections_req(),
    channels_pb:remove_client_connections_req() | grpcbox_client:options()
) ->
    {ok, channels_pb:remove_client_connections_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
-spec remove_client_connections(
    ctx:t(), channels_pb:remove_client_connections_req(), grpcbox_client:options()
) ->
    {ok, channels_pb:remove_client_connections_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
-spec unset_parent_group_from_channels(channels_pb:unset_parent_group_from_channels_req()) ->
    {ok, channels_pb:unset_parent_group_from_channels_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
unset_parent_group_from_channels(Input) ->
    unset_parent_group_from_channels(ctx:new(), Input, #{}).

-spec unset_parent_group_from_channels(
    ctx:t() | channels_pb:unset_parent_group_from_channels_req(),
    channels_pb:unset_parent_group_from_channels_req() | grpcbox_client:options()
) ->
    {ok, channels_pb:unset_parent_group_from_channels_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
-spec unset_parent_group_from_channels(
    ctx:t(), channels_pb:unset_parent_group_from_channels_req(), grpcbox_client:options()
) ->
    {ok, channels_pb:unset_parent_group_from_channels_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
unset_parent_group_from_channels(Ctx, Input, Options) ->
    grpcbox_client:unary(
        ...
        ?DEF(
            ...
            <<"channels.v1.UnsetParentGroupFromChannelsReq">>
        ),
        Options
    ).
...
-spec retrieve_entity(channels_pb:retrieve_entity_req()) ->
    {ok, channels_pb:retrieve_entity_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
retrieve_entity(Input) ->
    retrieve_entity(ctx:new(), Input, #{}).

-spec retrieve_entity(
    ctx:t() | channels_pb:retrieve_entity_req(),
    channels_pb:retrieve_entity_req() | grpcbox_client:options()
) ->
    {ok, channels_pb:retrieve_entity_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
retrieve_entity(Ctx, Input, Options) ->
    grpcbox_client:unary(
        ...
        Input,
        ?DEF(retrieve_entity_req, retrieve_entity_res, <<"common.v1.RetrieveEntityReq">>),
        Options
    ).
...
-spec retrieve_id_by_route(
    ctx:t() | channels_pb:retrieve_id_by_route_req(),
    channels_pb:retrieve_id_by_route_req() | grpcbox_client:options()
) ->
    {ok, channels_pb:retrieve_entity_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
...
-spec retrieve_id_by_route(
    ctx:t(), channels_pb:retrieve_id_by_route_req(), grpcbox_client:options()
) ->
    {ok, channels_pb:retrieve_entity_res(), grpcbox:metadata()}
    | grpcbox_stream:grpc_error_response()
    | {error, any()}.
retrieve_id_by_route(Ctx, Input, Options) ->
    grpcbox_client:unary(
        ...
        Input,
        ?DEF(retrieve_id_by_route_req, retrieve_entity_res, <<"common.v1.RetrieveIDByRouteReq">>),
        Options
    ).
